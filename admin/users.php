...
<body class="flex min-h-screen text-gray-800">
    ...
    <aside class="sidebar w-80 flex-shrink-0 flex flex-col hidden md:flex">
        ...
        <nav class="flex-1 px-4 space-y-2">
            <p class="px-8 text-[11px] font-black uppercase tracking-[0.2em] text-gray-500 mb-4 mt-6">Overview</p>
            ...
            <a href="inquiries.php" class="sidebar-link flex items-center gap-4 px-8 py-5 rounded-2xl text-[16px] font-black uppercase tracking-widest">
                <i class="fa-solid fa-message w-6"></i> Inquiries
            </a>
            
            <p class="px-8 text-[11px] font-black uppercase tracking-[0.2em] text-gray-500 mb-4 mt-10">Management</p>
            <a href="inventory.php" class="sidebar-link flex items-center gap-4 px-8 py-5 rounded-2xl text-[16px] font-black uppercase tracking-widest">
                <i class="fa-solid fa-layer-group w-6"></i> Inventory
            </a>

            <p class="px-8 text-[11px] font-black uppercase tracking-[0.2em] text-gray-500 mb-4 mt-10">System</p>
            <a href="users.php" class="sidebar-link active flex items-center gap-4 px-8 py-5 rounded-2xl text-[16px] font-black uppercase tracking-widest">
            ...
            <a href="database.php" class="sidebar-link flex items-center gap-4 px-8 py-5 rounded-2xl text-[16px] font-black uppercase tracking-widest">
                <i class="fa-solid fa-database w-6"></i> Database
            </a>
            
            <div class="p-10 border-t border-white/5 mt-auto">
